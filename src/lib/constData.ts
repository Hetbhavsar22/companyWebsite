...
export const homeAccordiandata = {
  data: [
    ...
    },
    {
      ...
      desc: "Yamuna Digitech Pvt. Ltd. AI consulting and development experts will address your business challenges using readily available and custom-trained models. Our AI app development know-how spans from ML and DL to NLP, Computer Vision, Generative AI, and IPA.      ",
    },
    {
      id: 6,
...
export const tabdata = {
  ...
  data: [
    ...
    },
    {
      ...
      content:
        "Yamuna Digitech Pvt. Ltd. Group also provides end-to-end software product engineering services. We’ll dive into your project requirements, come up with a technology vision and estimates, assemble a winning team that will dedicate 100% of their time to your project, and deliver a software solution while keeping you informed and fully in charge of the development process.",
...
export const footerdata = {
  ...
  address:
    "F-811,Titanium city center corporate offeces, 100 feet Anand Nagar Rd, Ahemdabad, Gujarat, 380015",
  email: "yamunadigitechnology@gmail.com",
  mobile: "+91 7433850325",
  privacy: "Privacy Policy",
  copyright: "2025 Yanuna Digitech Pvt. ltd.",
  data: [
    {
      id: 1,
      icon: "/icons/iso.svg",
  ...
  social: [
    ...
    // },
    {
      ...
      title: "Instagram",
      link: "https://www.instagram.com/yamunadigitechpvtltd/",
    },
    {
      id: 2,
      icon: "/icons/linkedin.svg",
      title: "Linkedin",
      link: "https://www.linkedin.com/company/106495515/admin/page-posts/published/",
    },
    // {
    //   id: 3,
    ...
    // },
    {
      ...
      link: "https://x.com/YamunaDigitech",
    },
  ],
};
...
export const Card1 = {
  cards: [
    ...
    },
    {
      ...
      title: "Yamuna Digitech Pvt. Ltd. launches two more initiatives",
      description:
        "Learn how Yamuna Digitech Pvt. Ltd. continues to provide much-needed assistance to Ukranians living in crisis since Russia began its invasion.",
      height: 200,
      width: 300,
      title1: "Initiatives",
    },
...
export const serviceicon = {
  ...
  data: [
    ...
    },
    {
      ...
      languages: "",
      description:
        "The Yamuna Digitech Pvt. Ltd. software engineering service team will follow DevOps best practices to set up a complete cloud infrastructure for your software solution, ensure faster updates, and monitor application performance. We offer three tiers of support, too.",
    },
    {
...
export const banner = {
  ...
  description:
    "Overhaul business processes, modernize existing technology systems, and bring innovative technology product to market with Yamuna Digitech Pvt. Ltd. — a software engineering company that cares",
};
...
export const Bgbanner1 = {
  description:
    "As an IT firm that went all the way from a software engineering outsourcing company to a technology vendor with niche expertise, Yamuna Digitech Pvt. Ltd. offers flexible engagement models to meet your requirements:",
};
...
export const testimonial = {
  data: [
    ...
    },
    {
      ...
      description:
        "Yamuna Digitech Pvt. Ltd. is an outstanding partner. They don't even feel like a contractor, but more like a fully integrated team.",
    },
    {
      id: 3,
      ...
      description:
        "Yamuna Digitech Pvt. Ltd.’s team are experts in their trade. The&nbsp;software development they provided was critical to advancing the project to the next level.",
    },
  ],
};
  ...
  data: [
    {
      ...
      description:
        "The Yamuna Digitech Pvt. Ltd. software product engineering firm is well-versed in enterprise IT technologies. ERP systems, CRM and help desk solutions, document and learning management systems, HRM and project management software, accounting and eProcurement tools — you can find it all in our portfolio.",
    },
    {
      ...
      title: "Artificial Intelligence",
      description:
        "We take pride in our AI expertise and offer a wide range of innovative software engineering services to supercharge your technology systems. Partner with Yamuna Digitech Pvt. Ltd. to develop apps with computer vision capabilities, train highly accurate machine learning models, and reduce bias in custom AI deployments. ",
    },
    {
    ...
    },
    {
      ...
      title: "Big Data & Analytics",
      description:
        "Yamuna Digitech Pvt. Ltd. Group is a software engineering company with a strong background in data science. Do you need help customizing SaaS business intelligence (BI) products to best suit your analytics? Are you struggling to interpret unstructured data or ensure an uninterrupted flow of information across your IT infrastructure? Whatever your objectives are, we’ve got you covered!    ",
    },
    {
      url: "/images/accord_5-5.gif",
      languages: "",
...
export const YellowBannerData1 = {
  description:
    "With a deep understanding of industry-specific challenges and requirements, the Yamuna Digitech Pvt. Ltd. app development company delivers products tailored to your needs. Whether you are a startup aiming to disrupt the market or an enterprise looking to improve employee productivity, obtain valuable data insights or build a loyal customer base, we are ready to take on the challenge.",
};
...
export const webSection = {
  texts:
    "Our mission is to take business like yours to the top. That’s why Yamuna Digitech Pvt. Ltd. is more than just a professional provider of custom web development services. Innovators at heart, we help you turn the latest tech innovations into exceptional business value. We help you outrun the competition.",
  button1: "Contact Us",
  button2: "",
  heading: "",
  data: [
...
export const imageBanner10 = {
  url: "/images/soft3.webp",
  title1: "How Yamuna Digitech Pvt. Ltd.",
...
export const careermany = {
  ...
  desc1:
    "If you feel like you’d thrive at Yamuna Digitech Pvt. Ltd., we’d love to hear from you. Please browse through our vacancies",
...
export const Bgbanner4 = {
  description:
    "For more than a decade, Yamuna Digitech Pvt. Ltd. SaaS development company has been empowering enterprises and startups across industries by delivering secure and scalable SaaS solutions. Tell us the type of SaaS you want to create and we will help you too.",
};
...
export const careerpage2data = {
  ...
  title: "Who we are",
  des1: "Yamuna Digitech Pvt. Ltd. is more than 300 technology professionals based in Poland,Georgia, Ukraine, Armenia, and the USA. We write software, craft strategies, and give expert advice.",
...
export const uiGrid2 = [
  ...
  },
  {
    ...
    title1: "Dashboards",
    description:
      "A UI/UX company with solid data visualization expertise, Yamuna Digitech Pvt. Ltd. designs sleek cloud dashboards and interfaces for self-service BI and data analytics tools like no other. We’ll implement custom logic, filters, charts, and collaboration tools to help you interpret business data and make better decisions",
  },
  {
    id: 5,
...
export const howbanner = {
  ...
  desc: "Team up with Yamuna Digitech Pvt. Ltd. at any stage of your project, choosing the engagement model that fits best your project scope and business priorities.",
  desc1:
...
export const aboutBanner2 = {
  ...
  section: [
    ...
    },
    {
      ...
      title1: "We say “we” ",
      title2:
        " since we are a big Yamuna Digitech Pvt. Ltd. family united together around one goal - to help you innovate for growth.",
    },
  ],
};
...
export const careerpage7data = {
  ...
  desc2:
    " Working at Yamuna Digitech Pvt. Ltd., you’ll watch us admit mistakes all the time. That’s what initiative and transparency looks like.",
  desc3:
...
export const backSection = {
  ...
  section: [
    ...
    },
    {
      ...
      description:
        "As part of our back-end web development services, we build applications from the ground up or assist our clients’ front-end teams on a dedicated team or pay-as-you-go basis. Hire back-end developers at Yamuna Digitech Pvt. Ltd. if you need a customer-facing portal, sleek e-commerce website, or enterprise-grade web application!",
    },
    {
...
export const backicon = [
  {
    ...
    description:
      "The Yamuna Digitech Pvt. Ltd. back-end development services for the enterprise segment include the creation of fail-proof, scalable back-office systems and server-side infrastructure for ERP, SCM, CRM, DMS, LMS, MarTech, and FinTech applications",
  },
  {
    languages: "",
    url: "/images/accord_2-2.gif",
    ...
    description:
      "If you hire back-end developers at Yamuna Digitech Pvt. Ltd., you’ll get a team of experts in data warehouse, data lake, and data lakehouse solutions. We’re also no strangers to business intelligence (BI) and can set up a complete data ecosystem driven by AI algorithms, too",
  },
  {
    languages: "",
    url: "/images/accord_3-3.gif",
...
export const uiuxbox = [
  {
    ...
    discription:
      "When you hire UI/UX designers at Yamuna Digitech Pvt. Ltd., you get a team with the right soft and hard skills, recognized certifications, a powerful toolset, and unleashed imagination.",
  },
  {
    id: 2,
