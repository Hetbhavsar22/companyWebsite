...
export async function POST(req: NextRequest) {
  try {
    ...
    <p>Thank you for reaching out to Yamuna Digitech Pvt. Ltd. We have received your project inquiry and appreciate your interest in our services.</p>
    ...
    <p>Best regards,<br>Vrajesh Shiroya<br>CEO<br>Yamuna Digitech Pvt. Ltd.</p>`;
    ...
    await transporter.sendMail({
      ...
      to: email,
    //   bcc: process.env.BCC_EMAIL,
      subject: "Thank you for your inquiry - Yamuna Digitech Pvt. Ltd.",
      html: emailContent,
      attachments,
    });
